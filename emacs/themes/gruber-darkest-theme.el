...
;; Colors with +x are lighter. Colors with -x are darkest.
(let ((gruber-darkest-fg        "#e4e4ef")
      ...
      (gruber-darkest-bg        "#000000")
      (gruber-darkest-bg+1      "#282828")
      (gruber-darkest-bg+2      "#453d41")
      ...
      (gruber-darkest-green     "#73c936")
      (gruber-darkest-yellow    "#ffdd33")
      (gruber-darkest-brown     "#cc8c3c")
      (gruber-darkest-quartz    "#95a99f")
      (gruber-darkest-niagara-2 "#303540")
      (gruber-darkest-niagara-1 "#565f73")
      (gruber-darkest-niagara   "#96a6c8")
      (gruber-darkest-wisteria  "#9e95c7")
      )
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:background ,gruber-darkest-yellow))))
   ...
   `(company-tooltip-common ((t (:foreground ,gruber-darkest-green))))
   `(company-tooltip-common-selection ((t (:foreground ,gruber-darkest-green))))
   `(company-scrollbar-fg ((t (:background ,gruber-darkest-bg-1))))
   `(company-scrollbar-bg ((t (:background ,gruber-darkest-bg+2))))
   `(company-preview ((t (:background ,gruber-darkest-green))))
   `(company-preview-common ((t (:foreground ,gruber-darkest-green :background ,gruber-darkest-bg-1))))
